...
import AssignmentIcon from '@mui/icons-material/Assignment'; // For Appointments
...
const AdminHome = () => {
  ...
  const [activeMenuItem, setActiveMenuItem] = useState('appointments'); // default to appointments
      ...
      <div className="layout">
        <div className="sidebar">
          ...
          <div className="menu">
            ...
            <div className={`menu-items ${activeMenuItem === 'appointments' ? 'active' : ''}`} onClick={() => handleMenuItemClick('appointments')}>
              <AssignmentIcon className='icon' /><Link>Appointments</Link>
            </div>
        ...
        <div className="content">
          ...
          <div className="body">
            ...
            {activeMenuItem === 'appointments' && <AdminAppointments />}
          </div>
        </div>
      </div>
    </div>
